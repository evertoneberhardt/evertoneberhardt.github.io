...
//----funcao para atualizar o menu co o nome dos meses----
...
function carregaDados(dado) {
	...
	for (i = 0; i < dados[dado].length; i++ ) {
		...
		document.getElementById('main').innerHTML += '<div class="linhas"><div class="dia">\
		<span class="texto">'+ dados[dado][i]["dia"] +'</span></div><div class="evento">\
		<span class="alinha_evento">'+ dados[dado][i]["evento"] +'</span></div>\
